...
- (void)configDefaultRequestHeader
{
    ...
    [self addValue:@"Mozilla/5.0 (Macintosh; Intel Mac OS X 10_14_0) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/74.0.3729.169 Safari/537.36" forHTTPHeaderField:@"User-Agent"];
